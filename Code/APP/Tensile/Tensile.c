...
void Tensile_Read_LVDT(void) {
    ...
    //u1_printf("%f\r\n",output);
    Tensile.LVDT.position = Tensile.LVDT.range * output / (Tensile.LVDT.output_max - Tensile.LVDT.output_min) - Tensile.LVDT.offset_velocity;
