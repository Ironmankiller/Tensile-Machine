...
//    if(Mecanum.Run_Mode_Flag == Speed)//速度模式
//    {		
//	    //=============显示电机A的状态=======================//	
...
//		                        OLED_ShowNumber(95,40, Mecanum.Encoder_D,4,12);
//	}
//	else if(Mecanum.Run_Mode_Flag == Position)//位置模式
//    {		
//		//=============显示电机A的状态=======================//	
//	    if(Mecanum.Target_A<0)  OLED_ShowString(00,10,"-"),
//		                        OLED_ShowNumber(15,10,-Mecanum.Target_A,5,12);
...
//		                        OLED_ShowNumber(15,10, Mecanum.Target_A,5,12); 
//		
//		if(Mecanum.Position_A<0)OLED_ShowString(80,10,"-"),
//		                        OLED_ShowNumber(95,10,-Mecanum.Position_A,4,12);
//		else                 	OLED_ShowString(80,10,"+"),
//		                        OLED_ShowNumber(95,10, Mecanum.Position_A,4,12);
//		//=============显示电机B的状态=======================//	
//		if(Mecanum.Target_B<0)	OLED_ShowString(00,20,"-"),
...
//		                        OLED_ShowNumber(15,20, Mecanum.Target_B,5,12); 
//		  
//		if(Mecanum.Position_B<0)OLED_ShowString(80,20,"-"),
//		                        OLED_ShowNumber(95,20,-Mecanum.Position_B,4,12);
//		else                 	OLED_ShowString(80,20,"+"),
//		                        OLED_ShowNumber(95,20, Mecanum.Position_B,4,12);
// 		//=============显示电机C的状态=======================//	
//		if( Mecanum.Target_C<0) OLED_ShowString(00,30,"-"),
...
//		if(Mecanum.Position_C<0)OLED_ShowString(80,30,"-"),
//		                        OLED_ShowNumber(95,30,-Mecanum.Position_C,4,12);
//		else                 	OLED_ShowString(80,30,"+"),
//		                        OLED_ShowNumber(95,30, Mecanum.Position_C,4,12);	
//		//=============显示电机D的状态=======================//	
//		if(Mecanum.Target_D<0)  OLED_ShowString(00,40,"-"),
...
//		                        OLED_ShowNumber(15,40, Mecanum.Target_D,5,12); 
//		
//		if(Mecanum.Position_D<0)OLED_ShowString(80,40,"-"),
//		                        OLED_ShowNumber(95,40,-Mecanum.Position_D,4,12);
//		else                 	OLED_ShowString(80,40,"+"),
//		                        OLED_ShowNumber(95,40, Mecanum.Position_D,4,12);
//	}
//		//=============第五行显示电压=======================//
