...
void Mecanum_Param_Init(void)
{
    ...
    Mecanum.Run_Mode_Flag = Speed;
    Mecanum.RC_Velocity = 30.0f;
	Mecanum.RC_Position = 300.0f;
	Mecanum.Gyro_K=0.003;
}
...
void Mecanum_Update(int A,int B,int C,int D)
{
	...
	Mecanum.Position_A += A;
	Mecanum.Position_B += B;
	Mecanum.Position_C += C;
	Mecanum.Position_D += D;
